        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
            ...
            <Table>
              ...
              <TableBody>
                {filteredStudents.map((student) => (
                  <TableRow key={student.id} className="border-b border-gray-100 last:border-b-0">
          ...
          <div className="flex items-center justify-between text-sm text-gray-600 mt-6">
            ...
            <div className="flex items-center gap-2">
              <button type="button" className="w-8 h-8 rounded-md border border-gray-200 bg-white text-gray-600 hover:bg-gray-50">←</button>
              <button type="button" className="w-8 h-8 rounded-md border border-gray-200 bg-white text-gray-600 hover:bg-gray-50">→</button>
            </div>
          </div>
        </div>
      ...
      {selectedStudents.length > 0 && (
        <div className="fixed bottom-6 right-6 z-50">
          <Button
            ...
            className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-2"
          >
